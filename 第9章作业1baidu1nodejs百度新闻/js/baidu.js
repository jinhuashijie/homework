...
window.onload = function(){
    ...
    $("bdlogininput1").onclick = function(b){
        $("bdlogininput1").style.background = "url(img/loginhead2.png) no-repeat white";
        $("bdlogininput2").style.background = "url(img/loginlock.png) no-repeat white";
    ...
    document.onclick = function(c){
        $("bdlogininput1").style.background = "url(img/loginhead.png) no-repeat white";
        $("bdlogininput2").style.background = "url(img/loginlock.png) no-repeat white";
        $("bdlogininput2").style.backgroundPosition= " 1px 9px";
        $("bdlogininput1").style.backgroundPosition= " 1px 9px";
    }
    $("bdlogininput2").onclick = function(c){
        $("bdlogininput2").style.background = "url(img/loginlock2.png) no-repeat white";
         $("bdlogininput1").style.background = "url(img/loginhead.png) no-repeat white";
         $("bdlogininput1").style.backgroundPosition= " 1px 9px";
